            ...
            <div class="recomendacion__destino">
                <div class="recomendacion__card">
                    <div class="recomendacion__img__con">
                        <img src="<?=Utils::img() ?>destino1.webp" alt="" class="recomendacion__img">
                    </div>
                    <div class="titulos">
                ...
                <div class="recomendacion__card">
                    <div class="recomendacion__img__con">
                        <img src="<?=Utils::img() ?>destino2.webp" alt="" class="recomendacion__img">
                    </div>
                    <div class="titulos">
                ...
                <div class="recomendacion__card">
                    <div class="recomendacion__img__con">
                        <img src="<?=Utils::img() ?>destino3.webp" alt="" class="recomendacion__img">
                    </div>
                    <div class="titulos">
                ...
                <div class="recomendacion__card">
                    <div class="recomendacion__img__con">
                        <img src="<?=Utils::img() ?>destino4.webp" alt="" class="recomendacion__img">
                    </div>
                    <div class="titulos">
                ...
                <div class="recomendacion__card">
                    <div class="recomendacion__img__con">
                        <img src="<?=Utils::img() ?>destino5.webp" alt="" class="recomendacion__img">
                    </div>
                    <div class="titulos">
        ...
        <section class="formulario">
            ...
            <div class="content">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#vueloredondo" role="tab"
                            aria-controls="home" aria-selected="true">Vuelo Redondo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#vuelosencillo" role="tab"
                            aria-controls="profile" aria-selected="false">Vuelo Sencillo</a>
                    </li>
                </ul>
                            ...
                            <form class="formulario__registro__grid" id="redondo">
                                ...
                                <div class="reserva__form">
                                    ...
                                    <select name="detino" id="destino">
                                        ...
                                        <option value="1">Las Bahamas</option>
                                        <option value="2">Mérida</option>
                                        <option value="3">La Habana</option>
                                        <option value="4">Republica Dominicana</option>
                                    </select>
                                </div>
                                <div class="reserva__form">
